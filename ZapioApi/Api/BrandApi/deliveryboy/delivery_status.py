...
class DeliveryBoyAction(APIView):
	"""
	Delivery Boy Action POST API
		...
		Response: {
			...
			"success": True, 
			"message": "Delivery boy is deactivated now!!",
			"data": final_result
		}
	...
	def post(self, request, format=None):
		try:
			...
			if record.count() != 0:
				...
				serializer = \
				DeliveryBoySerializer(record[0],data=data,partial=True)
