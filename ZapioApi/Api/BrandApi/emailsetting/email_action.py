...
class EmailAction(APIView):
	"""
	Email Action POST API

		Authentication Required		: Yes
		Service Usage & Description	: This Api is used to activate or deactivate email configuration.
		...
		Response: {
			...
			"success": True, 
			"message": "Email Configuration setting is deactivated successfully!!",
			"data": final_result
		}
