	...
	def post(self, request, format=None):
		try:
			...
			response=requests.get(url, \
				headers=\
				{"Authorization":\
				".eJwNxMERwCAIBMBeeMcZARWpJZPHCaT_EpJ97E3LPLDnahWINtzRwH-Rxn3VeGd1uihLw9lCU9FlS0rF4blhKkg99HwAchRa.XkeI1g.o_f8ObCDCoVgTdhAGsCLDRIROJc"})
			...
			for i in resdata:
				...
				alldata1 = POSOrder.objects.filter(invoice_number=i['invoice_number'])
				if alldata1.count() == 1:
